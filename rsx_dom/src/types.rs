...
use djed_rsx_shared::traits::{
    ...
    dom_traits::{TDOMNode, TDOMText}
};

#[cfg(feature = "rsx-parse")]
pub use djed_rsx_parser::*;
pub use djed_rsx_shared::types::{
    event_types::{Closure},
    prop_types::{Prop},
    dom_types::{EventType, KnownAttributeName, KnownElementName}
};

use super::util::{find_src, is_event_listener, is_style};
    ...
    L: TLayoutNode
{
        ...
        L: TLayoutNode<Styles = S>
    {
        self.data.attributes_mut()?.push(DOMAttribute::from((
            ...
            DOMAttributeValue::Styles(styles)
        )));
